    ...
    <>
      <div className="tw-flex-grow-0 tw-flex-shrink-0 tw-w-[55vw] tw-h-auto">
        <video
          ...
          muted
        />
        <p className="tw-w-[55vw] tw-h-[213px] tw-absolute tw-left-[46px] tw-top-[99px] tw-text-[3vw] tw-font-black tw-italic tw-text-left tw-text-white/[0.8]">
          Find Your Place, Build Your Community.
        </p>
        <div className="tw-absolute tw-inset-y-0 tw-right-[45vw] tw-w-2/4 tw-bg-gradient-to-l tw-from-[#111] tw-to-transparent tw-z-10"></div>
      </div>
    </>
  );
}
